...
from .views import (
    ...
    search,
    search_for_decklist,
    deprecated_decklist_url,
    create_decklist,
    edit_decklist,
    edit_decklist_mobile,
    view_decklist,
    view_user_public,
    delete_decklist,
    logout,
...
from .views.tournament import (
    ...
    tournament_detail,
    tournament_decklist,
    delete_tournament_registration,
    tournament_remove_invalid,
...
from .views.tournament.admin.post import (
    decklist_reveal_status,
...
urlpatterns = [
    ...
    path(
        "deck/<int:decklist_id>/",
        lambda req, decklist_id=None: redirect("cardDatabase-view-decklist", decklist_id=decklist_id),
    ),
    path("view_decklist/<int:decklist_id>/", view_decklist.get, name="cardDatabase-view-decklist"),
    path(
        "view_decklist/<int:decklist_id>/<str:share_parameter>/",
        view_decklist.get,
        name="cardDatabase-view-decklist-share",
    ),
    ...
    path(
        "login/",
        DjangoAuthViews.LoginView.as_view(template_name="registration/login.html", authentication_form=UserLoginForm),
        name="cardDatabase-login",
    ),
    ...
    path(
        ...
        export_decklist_share.get,
        name="cardDatabase-export-decklist-share",
    ),
    ...
    path(
        "tournament/<int:tournament_id>/edit/error/", edit_tournament.error, name="cardDatabase-error-edit-tournament"
    ),
    ...
    path(
        "tournament/<int:tournament_id>/player/registration/",
        tournament_player_register.get,
        name="cardDatabase-player-register-tournament",
    ),
    ...
    path(
        "api/tournament/<int:tournament_id>/players/",
        get_tournament_players.get,
        name="cardDatabase-get-tournament-players",
    ),
    path(
        "api/tournament/<int:tournament_id>/render-players/",
        get_tournament_players.getHtml,
    ...
    path(
        "tournament/<int:tournament_id>/deck/change",
        tournament_player_change_decklist.get,
        name="cardDatabase-tournament-change-decklist",
    ),
    path(
        "tournament/create/unauthorized",
        tournament_create_unauthorized.get,
        name="cardDatabase-tournament-create-unauthorized",
    ),
    # TOURNAMENT POST
    ...
    path(
        "api/tournament_player_register/<int:tournament_id>/",
        tournament_player_register.post,
        name="cardDatabase-register-player-to-tournament",
    ),
    path(
        "api/tournament/<int:tournament_id>/phase/update/",
        update_tournament_phase.post,
        name="cardDatabase-update-tournament-phase",
    ),
    path(
        "api/tournament/<int:tournament_id>/players/update/",
        update_tournament_players.post,
        name="cardDatabase-save-tournament-players",
    ),
    path(
        "api/tournament/<int:tournament_id>/decklist/reveal/update/",
        decklist_reveal_status.post,
        name="cardDatabase-update-tournament-decklist-reveal-status",
    ),
    path(
        "api/tournament/<int:tournament_id>/reset/phase",
        reset_phase.post,
        name="cardDatabase-update-tournament-reset-phase",
    ),
    path(
        "api/tournament/<int:tournament_id>/lock/deck-edit",
        lock_deck_edit.post,
        name="cardDatabase-update-tournament-lock-deck-edit",
    ),
    path(
        "api/tournament/<int:tournament_id>/players/remove/<int:player_id>/",
        remove_tournament_player.post,
        name="cardDatabase-remove-tournament-player",
    ),
    path(
        "api/tournament/<int:tournament_id>/deck/change",
        tournament_player_change_decklist.post,
        name="cardDatabase-tournament-change-player-decklist",
    ),
    path("api/tournament/<int:tournament_id>/staff/add/", staff_add.post, name="cardDatabase-tournament-staff-add"),
    path(
        "api/tournament/<int:tournament_id>/staff/remove/",
        staff_remove.post,
        name="cardDatabase-tournament-staff-remove",
    ),
]
